...
import {readAllPatients, readPatient,readVaccine,createPatient,createVaccination,updatePatient,updateVaccine,deletePatient,deleteVaccine, readAllVaccinations}  from "../DB/database.js";
...
server.get("/vaccinations",async (req,res)=>{
  const vaccinations = await readAllVaccinations();
  res.send(vaccinations);
})
